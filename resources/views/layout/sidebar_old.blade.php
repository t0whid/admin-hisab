 ...
 <aside id="leftsidebar" class="sidebar">
     <div class="navbar-brand">
         ...
         <a href="index.html"><img src="{{ asset('assets/backend/images/logo.svg') }}" width="25" alt="Aero"><span
                 class="m-l-10">Shahjalal Enterprise</span></a>
     </div>
     <div class="menu">
         <ul class="list">
             <li>
                 <div class="user-info">
                     <a class="image" href="profile.html">
                         <img src="{{ $user->image ? asset($user->image) : asset('assets/backend/images/profile_av.jpg') }}"
                             alt="User">
                     </a>
             ...
             <li class="active open"><a href="{{route('index')}}"><i class="zmdi zmdi-home"></i><span>Dashboard</span></a>
             </li>
             <li><a href="javascript:void(0);" class="menu-toggle"><i
                         class="zmdi zmdi-apps"></i><span>Customers</span></a>
                 <ul class="ml-menu">
