...
<body class="theme-blush">
    ...
    {{--  <div class="page-loader-wrapper">
        <div class="loader">
            <div class="m-t-30"><img class="zmdi-hc-spin" src="{{asset('assets/backend/images/loader.svg')}}" width="48" height="48"
                    alt="Aero"></div>
            <p>Please wait...</p>
        </div>
    </div> --}}
                            ...
                            <li>
                                <div class="progress-container progress-primary">
                                    ...
                                    <ul class="list-unstyled team-info">
                                        ...
                                        <li>
                                            <img src="{{ asset('assets/backend/images/xs/avatar2.jpg') }}"
                                                alt="Avatar">
                                        </li>
                                        <li>
                                            <img src="{{ asset('assets/backend/images/xs/avatar3.jpg') }}"
                                                alt="Avatar">
                                        </li>
                                        <li>
                                            <img src="{{ asset('assets/backend/images/xs/avatar4.jpg') }}"
                                                alt="Avatar">
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <li>
                                <div class="progress-container">
                                    ...
                                    <ul class="list-unstyled team-info">
                                        <li class="m-r-15"><small>Team</small></li>
                                        <li>
                                            <img src="{{ asset('assets/backend/images/xs/avatar10.jpg') }}"
                                                alt="Avatar">
                                        </li>
                                        <li>
                                            <img src="{{ asset('assets/backend/images/xs/avatar9.jpg') }}"
                                                alt="Avatar">
                                        </li>
                                        <li>
                                            <img src="{{ asset('assets/backend/images/xs/avatar8.jpg') }}"
                                                alt="Avatar">
                                        </li>
                                        <li>
                                            <img src="{{ asset('assets/backend/images/xs/avatar7.jpg') }}"
                                                alt="Avatar">
                                        </li>
                                        <li>
                                            <img src="{{ asset('assets/backend/images/xs/avatar6.jpg') }}"
                                                alt="Avatar">
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <li>
                                <div class="progress-container progress-warning">
                                    ...
                                    <ul class="list-unstyled team-info">
                                        <li class="m-r-15"><small>Team</small></li>
                                        <li>
                                            <img src="{{ asset('assets/backend/images/xs/avatar5.jpg') }}"
                                                alt="Avatar">
                                        </li>
                                        <li>
                                            <img src="{{ asset('assets/backend/images/xs/avatar2.jpg') }}"
